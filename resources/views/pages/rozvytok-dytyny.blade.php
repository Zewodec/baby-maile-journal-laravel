...
<h1 class="h1_anastasia text-center">Розвиток дитини</h1>
...
<section class="rozvitok-dytyny-section">
    ...
    <div class="rozvitok-dytyny-section__column">
        ...
        <a href="{{route('rozvytok-dytyny.vagitnist')}}">
    ...
    <div class="rozvitok-dytyny-section__column">
        ...
        <a href="{{route('rozvytok-dytyny.nemovlya')}}">
            <img src="{{URL::asset('images/rozvitok-dytyny/nemovlya.png')}}" alt="Вагітність"/>
        </a>
    </div>
